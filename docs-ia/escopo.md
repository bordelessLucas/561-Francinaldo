...
3a. A saída da análise deve poder afirmar que não há problema visível ou que a foto não se aplica a SST, sem inventar riscos.
...
- [x] Origem inicial da base NR para consulta/RAG: página oficial MTE de Normas Regulamentadoras (validada em 23/09/2026)
- [ ] Critérios da IA e formato exato do retorno da análise assertiva/RAG
- [ ] Pedidos exatos de mudança de UI do cliente
